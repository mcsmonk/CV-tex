...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Korea University\\
  145 Anam-ro, Seongbuk-gu, Seoul, 02841, Republic of Korea & last modified : 24 Mar 2022\\
\end{tabular*}
...
\begin{itemize}
    \item {\textbf{Korea University} \hfill Seoul, Republic of Korea}
        ...
        \begin{description}
            ...
            \vspace{-2pt}
            \item {Thesis: Side-Channel Key Recovery Attack on Secure ECDSA Implementations (working title)}
            \vspace{-2pt}
    ...
    \item {Peer Reviewing}
        ...
        \begin{itemize}
            ...
            \item {Subreviewer}
                \vspace{-4pt}
                \begin{enumerate}
                    \item {IACR ASIACRYPT : 2019}
                    \vspace{-2pt}
                    \item {IACR TCHES : 2021-1}
                    \vspace{-2pt}
                    \item {MDPI Sensors : 2021}
                    \vspace{-2pt}
                    \item {IEEE Access : 2022}
                \end{enumerate}
        \end{itemize}
\end{itemize}
