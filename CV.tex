...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Korea University\\
  145 Anam-ro, Seongbuk-gu, Seoul, 02841, Republic of Korea & last modified : 14 Oct 2021\\
\end{tabular*}
...
\iffalse
    \item {Work in progress}
        \vspace{-6pt}
        \begin{enumerate}
            \item {\textbf{Sunghyun Jin}, . (A tentative title) }
            \vspace{-2pt}
        \end{enumerate}
\fi
...
\begin{itemize}
    \item {\textbf{Supervisor}}
        \vspace{-6pt}
        \begin{description}
            \item {Seokhie Hong (\href{mailto:shhong@korea.ac.kr}{shhong@korea.ac.kr} , +82-02-3290-4894)}
            \vspace{-2pt}
            \item {HeeSeok Kim (\href{mailto:80khs@korea.ac.kr}{80khs@korea.ac.kr})}
        \end{description}
\end{itemize}
